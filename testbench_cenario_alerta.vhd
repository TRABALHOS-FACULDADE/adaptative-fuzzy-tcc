...
--
-- Inputs: CPU=160 (~63%), MEM=160 (~63%) em Q8.8
-- Esperado: result_class = "01" (ALERT), result_value = 171 (0x00AB)
--
-- Calculo manual (Q8.8):
--   Fuzzificacao (MF MED, lado descendente):
--     mu_med = (c - x) / (c - b) = (192 - 160) / (192 - 128) = 32/64 = 128
--     mu_low = 0  (x > c_low=85)
--     mu_high= 0  (x < a_high=171)
--
--   Regra ativa:
