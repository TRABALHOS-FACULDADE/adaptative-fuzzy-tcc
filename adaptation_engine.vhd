-- =============================================================================
-- adaptation_engine.vhd
-- Motor de Adaptacao Online (Microservico ms_adapt)
--
...
--   escreve de volta nos config_registers.
--
-- Aritmetica: ponto fixo Q8.8 (signed, 16 bits)
--   Intermediarios: Q16.16 (signed, 32 bits) para multiplicacoes
--
-- Raiz quadrada: Newton-Raphson iterativo (4 iteracoes para Q8.8)
--
...
end adaptation_engine;

architecture rtl of adaptation_engine is
