-- =============================================================================
-- ms_aggregate.vhd
-- [SOA] MICROSERVICE ms_aggregate — Aggregation by output class (MAX)
...
entity ms_aggregate is
    port (
        ...
        -- Lidas do Service Registry (config_registers)
...
architecture rtl of ms_aggregate is
